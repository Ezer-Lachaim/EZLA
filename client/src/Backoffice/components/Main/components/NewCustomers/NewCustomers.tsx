...
const columns: ColumnDef<Partial<TempCustomer>>[] = [
  {
    accessorKey: "pendingTimeMs",
    header: "זמן המתנה",
    accessorFn: (data) => data.pendingTimeMs,
  },
  {
  ...
  { accessorKey: "name", header: "שם נוסע", accessorFn: (data) => data.name },
  {
    ...
    header: "יצירת קשר",
    accessorFn: (data) => data.phoneNumber,
  },
  { accessorKey: "email", header: "אימייל", accessorFn: (data) => data.email },
  {
    accessorKey: "address",
    header: "כתובת איסוף",
    accessorFn: (data) => data.address,
  },
  {
    accessorKey: "reason",
  ...
  },
  {
    ...
    header: "בית חולים",
    accessorFn: (data) => data.hospitalName,
  },
  {
    accessorKey: "endDate",
    header: "תקופה",
  ...
  },
  {
    ...
    cell: (data) => {
      ...
      const AccpetDeclineUser = async (isAccepted: boolean) => {
        try {
          userApi.updateUser({
            userId: data.getValue() as string,
            user: { registrationState: isAccepted ? "Approved" : "Rejected" },
          });
        } catch (err) {
          console.log(err);
        }
        ...
        <div className="flex gap-1 items-center">
          ...
          <Stack direction="row" spacing={1}>
            ...
            <Button
              ...
              style={{ minWidth: 0 }}
              className="w-7 h-7"
              onClick={() => AccpetDeclineUser(true)}
            >
              <Check fontSize="small" />
            </Button>
          </Stack>
          <RejectCustomerModal
            AccpetDeclineUser={AccpetDeclineUser}
            open={toggleModal}
